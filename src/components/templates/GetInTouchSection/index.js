  ...
  return (
    <Layout className="GetInTouchSection" innerClassName="GetInTouchSection__Wrapper">
      ...
      <p className="GetInTouchSection__Text">
        ...
        <br />You can also find me on social media down below.
      </p>
      <div className="GetInTouchSection__SocialMediaButtons">
        {socialMedia.map(media => <Icon className="GetInTouchSection__SocialMediaButton" icon={media.platform} link={media.link} />)}
      </div>
    </Layout>
  )
}
